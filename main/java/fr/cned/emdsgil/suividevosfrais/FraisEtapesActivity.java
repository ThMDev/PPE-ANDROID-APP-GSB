...
public class FraisEtapesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frais_etapes);
        setTitle("GSB : Frais Étapes");
    ...
    private void valoriseProprietes() {
        ...
        ((TextView)findViewById(R.id.txtEtapes)).setText(String.format(Locale.FRANCE, "%d", qte)) ;
    }
    ...
    private void cmdValider_clic() {
        findViewById(R.id.cmdEtapesValider).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                Serializer.serialize(Global.listFraisMois, FraisEtapesActivity.this) ;
                retourActivityPrincipale() ;
            }
        }) ;
    }
    ...
    private void retourActivityPrincipale() {
        Intent intent = new Intent(FraisEtapesActivity.this, MainActivity.class) ;
