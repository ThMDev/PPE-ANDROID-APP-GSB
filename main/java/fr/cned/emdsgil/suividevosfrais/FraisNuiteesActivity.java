...
public class FraisNuiteesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frais_nuitees);
    ...
    private void cmdValider_clic() {
        findViewById(R.id.cmdNuiteesValider).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                Serializer.serialize(Global.listFraisMois, FraisNuiteesActivity.this) ;
                retourActivityPrincipale() ;
            }
        }) ;
    }
    ...
    private void retourActivityPrincipale() {
        Intent intent = new Intent(FraisNuiteesActivity.this, MainActivity.class) ;
